    ...
    <section className="max-w-7x1 mx-auto">
      ...
      <form className="mt-16 max-w-3x1" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
         <button type="button" onClick={generateImage} className=" text-white bg-green-700 font-medium rounded-md text-sm w-full sm w-full sm:w-auto px-5 py-2.5 text-center" >
